    ...
    <a-form @submit="handleSubmit" :form="form">
      ...
      <a-row>
        <a-col :span="16">
          ...
          >
            <a-input disabled v-model="addressUp"> </a-input>
          </a-form-item>
        </a-col>
        <a-col :span="8">
          <a-form-item
        ...
        <a-col :span="12">
          ...
          >
            ...
            >
              <a-row>
                <a-col :span="4">
                  <a-checkbox disabled value="鸡">
                    鸡
                  </a-checkbox>
                </a-col>
                <a-col :span="4">
                  <a-checkbox disabled value="牛">
                    牛
                  </a-checkbox>
                </a-col>
                <a-col :span="4">
                  <a-checkbox disabled value="猪">
                    猪
                  </a-checkbox>
                </a-col>
                <a-col :span="4">
                  <a-checkbox disabled value="羊">
                    羊
                  </a-checkbox>
                </a-col>
                <a-col :span="4">
                  <a-checkbox disabled value="鸭">
                    鸭
                  </a-checkbox>
                </a-col>
                <a-col :span="4">
                  <a-checkbox disabled value="鹅">
                    鹅
                  </a-checkbox>
                </a-col>
              </a-row>
      ...
      <a-row>
        <a-col :span="12">
          ...
          >
            ...
            >
              <a-button v-if="FhpwxkzP.length === 0 || !this.f" disabled>
      ...
      <a-row>
        <a-col :span="12">
          ...
          >
            ...
            >
              <a-button v-if="FhclsP.length === 0 || !this.f" disabled>
                <a-icon type="upload" /> 上传
              </a-button>
            </a-upload>
          </a-form-item>
      ...
      <a-row>
        <a-col :span="12">
          ...
          >
            ...
            >
              <a-button v-if="FhhgzP.length === 0 || !this.f" disabled>
                <a-icon type="upload" /> 上传
              </a-button>
            </a-upload>
          </a-form-item>
