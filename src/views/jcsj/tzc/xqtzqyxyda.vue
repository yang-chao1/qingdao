      ...
      <div class="div1">
        <div class="div3">
          ...
          <div style="margin-top:35px;">
            <a-button v-permission="{active:'slaugadd'}" type="primary" style="height:40px" icon="plus" @click="showModal()">新增</a-button
            >&nbsp;&nbsp;&nbsp;&nbsp;
            <!-- 新增 -->
            <a-modal
              :footer="null"
            ...
            <!-- --------------------------操作按钮--------------------------------------- -->
            <a-button v-permission="{active:'sladele'}" type="primary" style="height:40px" @click="delet()">批量删除</a-button
            >&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          >
            <template slot="action" slot-scope="text, record">
              ...
              <a slot="action" v-permission="{active:'slaupd'}" @click="GetTZCOFFItem(record)">启用或禁用&nbsp;&nbsp;</a>
