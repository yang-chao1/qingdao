  ...
  left: 84%; top: 0;"
          ...
          >
            ...
            <template slot="action" slot-scope="text, record">
              <a slot="action" v-permission="{active:'munksele'}" @click="fint(record)">查看&nbsp;&nbsp;</a>
            </template>
          </a-table>
    ...
    // 待审核申请查询
     checkapply () {
       this.$axios
        .get(
          http +
            '/After/shijiReviewed?Fyzname=' + this.Fyzname + '&FSunitId=' + this.FSunitId + '&offset=' +
            this.offset +
            '&limit=' +
            this.limit +
            '&FScTime=' +
