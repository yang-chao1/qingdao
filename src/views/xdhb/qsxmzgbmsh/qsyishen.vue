              ...
              <div class="all fujianguanli">
                ...
                <div>
                  <viewer :images="photoRep" class="photos">
                    <!-- //photo 一定要一个数组，否则报错 -->
                    <span>具有资质的兽医实验室出具相关强制免疫疫苗
                      免疫抗体检测报告原件（上半年、下半年各一
                ...
                <!-- <a-row type="flex" justify="space-between" align="bottom">
                  <a-col :span="12">
                    ...
                    <a-form-item :wrapper-col="{ span: 16, offset: 13 }">
                      <a-button type="primary" @click="auditOK" :span="8" style="width:150px; margin-top: 40px">
                        审核通过
                      </a-button>
                    </a-form-item>
                  </a-col>
  ...
  left: 84%; top: 0;"
          ...
          >
            ...
            <template slot="action" slot-scope="text, record">
              <a slot="action" v-permission="{active:'zonkele'}" @click="fint(record)">查看&nbsp;&nbsp;</a>
            </template>
          </a-table>
     ...
     checkapply () {
      this.FSuTime = new Date().getFullYear() + '/' + (new Date().getMonth() + 1) + '/' + new Date().getDate()
       this.$axios
        .get(
          http +
            '/After/QushiReviewed?Fyzname=' + this.Fyzname + '&FSunitId=' + this.FSunitId + '&offset=' +
            this.offset +
            '&limit=' +
            this.limit +
            '&FScTime=' +
