...
this.seven = this.man
 ...
 methods: {
   ...
   this.seven = this.seven.replace(/[^\d]/g, '')
    this.fix = this.fix.replace(/[^\d]/g, '')
     this.three = this.three.replace(/[^\d]/g, '')
    this.three1 = this.three1.replace(/[^\d]/g, '')
    this.three2 = this.three2.replace(/[^\d]/g, '')
  },
   qq () {
   ...
   deletearr () {
     if (this.zong.length === this.shuzu.length) {
       this.shuzu = []
       this.zong = []
     }
     this.arr = 0
     if (this.shuzu && this.zong) {
